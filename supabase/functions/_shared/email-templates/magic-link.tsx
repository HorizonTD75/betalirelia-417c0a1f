  ...
  <Html lang="fr" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Cliquez sur le bouton ci-dessous pour vous connecter à {siteName}. Ce lien expirera rapidement.
        </Text>
...
const button = { backgroundColor: '#0d3266', color: '#fef9eb', fontSize: '14px', borderRadius: '12px', padding: '12px 20px', textDecoration: 'none' }

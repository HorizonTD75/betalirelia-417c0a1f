        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/livraison" className="text-lg text-primary-foreground/80 hover:text-secondary transition-colors">Livraison</Link></li>
              <li><Link to="/retours-remboursements" className="text-lg text-primary-foreground/80 hover:text-secondary transition-colors">Retours et remboursements</Link></li>
              <li><Link to="/formulaire-retractation" className="text-lg text-primary-foreground/80 hover:text-secondary transition-colors">Formulaire de rétractation</Link></li>
              <li><Link to="/sav-garanties" className="text-lg text-primary-foreground/80 hover:text-secondary transition-colors">SAV et garanties</Link></li>

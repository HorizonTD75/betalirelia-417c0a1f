      ...
      <SEOHead
        ...
        jsonLd={[
          ...
          { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Lunette Loupe Frontale ALVA", item: "https://lirelia.fr/boutique/lunettes-loupe-frontale-alva" },
          ] },
        ]}
      />
      <Header />
                ...
                {descriptionBlocks.map((block) => (
                  <div key={block.title} className="bg-card rounded-2xl border-2 border-border p-6 md:p-8">
                    ...
                    {block.paragraphs.map((paragraph) => (
                      <p key={paragraph} className="text-lg text-foreground leading-relaxed mb-4 last:mb-0">{paragraph}</p>
                    ))}
                    {block.items && (

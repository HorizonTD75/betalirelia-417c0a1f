...
const LunettesLoupeFocus = () => {
  return (
    <div className="min-h-screen">
      <SEOHead title="Lunettes Loupe FOCUS pour Voir de Près | LirElia" description="Lunettes loupe FOCUS : grossissement 2,5x, réglage indépendant et mains libres pour lecture, couture, bricolage et activités de près." canonicalPath="/boutique/lunettes-loupe-focus" jsonLd={[

...
const LoupeMaxTv = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead title="Lunettes loupe Max-TV pour télévision et vision de loin" description="Lunettes loupe Max-TV : grossissement 2,1x pour regarder la télévision ou un écran à 2 à 5 mètres, avec réglage indépendant des deux yeux. Mains libres." canonicalPath="/boutique/loupe-max-tv" />
      <Header />

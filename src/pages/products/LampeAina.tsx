  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        canonicalPath="/boutique/lampe-tour-cou-aina"
        ogImage={imgNoirBlanche}
        jsonLd={[
          { "@context": "https://schema.org", "@type": "Product", "@id": "https://lirelia.fr/boutique/lampe-tour-cou-aina#product", name: "Lampe tour de cou AINA", description: "Lampe de lecture mains libres AINA, portée autour du cou ou posée sur la table — 2 modes d'éclairage, 3 températures de couleur, batterie rechargeable.", image: [`https://lirelia.fr${imgNoirBlanche}`], brand: { "@type": "Brand", name: "LirElia" }, offers: { "@type": "Offer", url: "https://lirelia.fr/boutique/lampe-tour-cou-aina", priceCurrency: "EUR", price: "49.20", availability: "https://schema.org/InStock" } },
          { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Lampe tour de cou AINA", item: "https://lirelia.fr/boutique/lampe-tour-cou-aina" },
          ] },
        ]}
      />
      <Header />

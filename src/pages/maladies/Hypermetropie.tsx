...
const Hypermetropie = () => {
  return (
    <div className="min-h-screen">
      <SEOHead
        title="Hypermétropie : causes, symptômes et traitement | LirElia"
        description="Comprendre l'hypermétropie : œil trop court, vision floue de près, fatigue visuelle. Causes, diagnostic, lunettes, lentilles et chirurgie réfractive."
      ...
      <main id="main-content">
        ...
        <section className="relative bg-primary text-primary-foreground py-20 overflow-hidden">
          <div className="absolute inset-0">
            <img src={maladiesHeroImage} alt="Les principales maladies des yeux causant la basse vision" className="w-full h-full object-cover opacity-20" aria-hidden="true" loading="eager" decoding="async" width={1440} height={500} />
          </div>
